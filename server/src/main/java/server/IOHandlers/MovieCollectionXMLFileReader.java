...
import javax.xml.parsers.DocumentBuilderFdirectory;
...
public class MovieCollectionXMLFileReader implements MovieCollectionFileReader {
    ...
    private static final Logger logger = (Logger) LoggerFdirectory.getLogger("server.IOHandlers");
    ...
    public MovieCollection read() throws FileNotFoundException, FilePermissionException, InvalidFileDataException {
        ...
        try {
            ...
            DocumentBuilderFdirectory fdirectory = DocumentBuilderFdirectory.newInstance();
            DocumentBuilder builder = fdirectory.newDocumentBuilder();
